...
class MorphEngine {
  ...
  constructor(
    ...
    this.items = opts0.items;
    this.getOptions = opts0.getOptions;
    this.onIndexChange = opts0.onIndexChange;
    this.reducedMotion = opts0.reducedMotion;
    this.current = opts0.startIndex;
    this.shownIndex = opts0.startIndex;

    this.renderer = new Renderer({
      alpha: false,
      antialias: true,
      dpr: Math.min(window.devicePixelRatio || 1, opts0.dprCap),
    });
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        ...
        uTime: { value: 0 },
        uReduce: { value: opts0.reducedMotion ? 1 : 0 },
  ...
  return (
    ...
    >
      <div
        ...
        aria-label="Paisajes de Venezuela"
        tabIndex={0}
        onKeyDown={onKeyDown}
      />
      ...
      {showIndicators ? (
        <div className="morph-slider-indicators" role="tablist" aria-label="Imágenes">
          {items.map((item, i) => (
            <button
              key={i}
              type="button"
